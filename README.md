...
### Core Features  
| Patient View | Doctor View | Appointments |
|-------------|-------------|-------------|
| ![Patient Chat](./screenshots/patientview_securechat.png) | ![Doctor Chat](./screenshots/doctorview_securechat.png) | ![Appointments](./screenshots/screenshot_appointmentbooking.png) |

### Additional Features  
| Video Consultation | Community Forum | User Dashboard |
|--------------------|----------------|----------------|
| ![Videochat](./screenshots/videochat.png) | ![Forum](./screenshots/forum.png) | ![Dashboard](./screenshots/dashboard.png) |
